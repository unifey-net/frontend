    ...
    return (
        <div className="flex flex-col justify-center items-center">
            ...
            <p className="max-w-lg">
                ...
                to count. However, in the near future we will have a limited
                beta run. What this means is that we'll allow specific users to
                ...
                beta begins. This email will include the account created for you.
            </p>
            ...
            <p className="max-w-lg">
                ...
                available on beta and other users may potentially be able to take your name.
            </p>
